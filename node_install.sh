...
# binary_v2 ha bagutta
curl -L -o /usr/local/nodejs_for_chromebook/installer https://github.com/soyaaaaana/nodejs-for-chromebook/releases/download/binary_v2/node_install_${URL_ARCH} 2>/dev/null
